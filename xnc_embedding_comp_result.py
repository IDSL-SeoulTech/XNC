...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_pt', type=str, default='/home/hyeok/XNC_compression/xnc_git/xnc_embedding_weight/SmolLM-135M/SmolLM-135M_embed_tokens_XNC.pt', help='Input pt file path')
    parser.add_argument('--output_txt', type=str, default='/home/hyeok/XNC_compression/xnc_git/result/SmolLM-135M_text_model_embed_tokens_XNC_compressed_output.txt', help='Output txt file path')
