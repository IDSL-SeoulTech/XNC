...
def main():
    ...
    parser.add_argument('--input', type=str, default='/home/hyeok/XNC_compression/xnc_git/embedding_weight/SmolLM-135M/model_embed_tokens_weight.pt', help='Input pt file path')
    parser.add_argument('--output', type=str, default='/home/hyeok/XNC_compression/xnc_git/xnc_embedding_weight/SmolLM-135M/SmolLM-135M_embed_tokens_XNC.pt', help='Output pt file path')
